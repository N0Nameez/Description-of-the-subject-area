...
CREATE TABLE `contractdetails` (
  ...
  `DateStartArend` date DEFAULT NULL,
  `Period` int DEFAULT NULL,
  `IdOutlet` int DEFAULT NULL,
  PRIMARY KEY (`IdContract`),
  KEY `fkContractDetailsOutlet_idx` (`IdOutlet`),
  CONSTRAINT `fkContractDetailsOutlet` FOREIGN KEY (`IdOutlet`) REFERENCES `outlet` (`IdOutlet`)
